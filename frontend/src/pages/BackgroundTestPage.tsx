 ...
 * 
 * Temporary page for tweaking the Tesla coil background.
 * Goal: Create a background that can be used across all pages.
 */

// Tesla Coil with Electric Arcs SVG Background
...
export function BackgroundTestPage() {
  return (
    <div className="min-h-screen bg-gray-950 relative">
      {/* The background we're testing */}
      <TeslaCoilBackground />
      
      {/* Optional: Sample content to see how it looks with UI elements */}
      <div className="relative z-10 p-8">
        <h1 className="text-3xl font-bold text-white mb-4">Background Test</h1>
        <p className="text-gray-400 mb-8">
          Tweak the TeslaCoilBackground component above to adjust the look.
          This will eventually be used across all pages.
        </p>
        
        {/* Sample cards to see contrast */}
        <div className="grid grid-cols-3 gap-4 max-w-4xl">
          <div className="bg-gray-900/80 backdrop-blur-sm border border-neon-cyan/30 rounded-xl p-6">
            <h3 className="text-neon-cyan font-semibold mb-2">Sample Card 1</h3>
            <p className="text-gray-400 text-sm">Content example</p>
          </div>
          <div className="bg-gray-900/80 backdrop-blur-sm border border-neon-purple/30 rounded-xl p-6">
            <h3 className="text-neon-purple font-semibold mb-2">Sample Card 2</h3>
            <p className="text-gray-400 text-sm">Content example</p>
          </div>
          <div className="bg-gray-900/80 backdrop-blur-sm border border-neon-green/30 rounded-xl p-6">
            <h3 className="text-neon-green font-semibold mb-2">Sample Card 3</h3>
            <p className="text-gray-400 text-sm">Content example</p>
          </div>
        </div>
      </div>
